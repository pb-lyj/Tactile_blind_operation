...
# === Main ===
def run_tactilecnn_gmm_clustering(data_root="./env_0", output_dir="./cluster/tactilecnn_output", n_clusters=5, auto_select_n=False):
    ...
    # Auto-select number of clusters if enabled
    if auto_select_n:
        lowest_bic = np.inf
        best_n = n_clusters
        for n in range(2, 11):
